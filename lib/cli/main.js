...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Komodo database directory')
    .option('-t, --testnet', 'Testnet disabled, never use this option!')
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('    $ bitcore-node add insight-api-komodo');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('    $ bitcore-node remove insight-api-komodo');
      console.log();
    });
