...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Zclassic database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('    $ bitcore-node add insight-api-zclassic');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('    $ bitcore-node remove insight-api-zclassic');
      console.log();
    });
